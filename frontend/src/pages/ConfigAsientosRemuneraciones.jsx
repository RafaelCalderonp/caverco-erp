...
const CAMPOS = [
  ...
  { key: 'id_cuenta_prevision_por_pagar',           label: 'AFP / SIS / Seguro Social por Pagar', grupo: 'Pasivos (HABER)' },
  { key: 'id_cuenta_cesantia_por_pagar',            label: 'AFC (Seguro Cesantía) por Pagar', grupo: 'Pasivos (HABER)' },
  { key: 'id_cuenta_salud_por_pagar',                label: 'Isapre / Fonasa por Pagar', grupo: 'Pasivos (HABER)' },
